    ...
    <footer className="border-t border-zinc-200 bg-white" suppressHydrationWarning>
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              {siteConfig.socials.twitter && (
                <a
                  href={`https://twitter.com/${siteConfig.socials.twitter.replace("@", "")}`}
                  target="_blank"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="mb-4 text-sm font-semibold text-zinc-900">Quick Links</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/account" className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors">
                  My Account
                </Link>
              </li>
            </ul>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="mb-4 text-sm font-semibold text-zinc-900">Customer Service</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/shipping" className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors">
                  Shipping Info
                </Link>
              </li>
              <li>
                <Link href="/returns" className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors">
                  Returns
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-zinc-200 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex gap-6 text-sm text-zinc-600">
              <span>Made with ❤️ for stationery lovers</span>
            </div>
          </div>
        </div>
      </div>
